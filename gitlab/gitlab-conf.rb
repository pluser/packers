...
external_url 'https://gitlab.pluser.net'
...
### Email Settings
 ...
 gitlab_rails['gitlab_email_from'] = 'gitlab@mail.gitlab.pluser.net'
 gitlab_rails['gitlab_email_display_name'] = 'GitLab.pluser.net'
 gitlab_rails['gitlab_email_reply_to'] = 'noreply@mail.gitlab.pluser.net'
...
###!   will appear signed in from that address.**
 gitlab_rails['trusted_proxies'] = ['192.168.32.10']
...
####!   "user" part of the address (before the `@`).**
 gitlab_rails['incoming_email_address'] = "gitlab-incoming+%{key}@mail.gitlab.pluser.net"

#### Email account username
####! **With third party providers, this is usually the full email address.**
####! **With self-hosted email servers, this is usually the user part of the
####!   email address.**
# gitlab_rails['incoming_email_email'] = "gitlab-incoming@mail.gitlab.pluser.net"

#### Email account password
# gitlab_rails['incoming_email_password'] = "2W5dW3QTnm9T"

#### IMAP Settings
# gitlab_rails['incoming_email_host'] = "s48.coreserver.net"
...
###! **Use smtp instead of sendmail/postfix.**
 ...
 gitlab_rails['smtp_address'] = "s48.coreserver.jp"
 gitlab_rails['smtp_port'] = 465
 gitlab_rails['smtp_user_name'] = "gitlab@mail.gitlab.pluser.net"
 gitlab_rails['smtp_password'] = "2W5dW3QTnm9T"
 gitlab_rails['smtp_domain'] = "mail.gitlab.pluser.net"
...
################################################################################
 ...
 registry_external_url 'http://docker.pluser.net'
